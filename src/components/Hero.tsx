...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center text-center min-h-[50rem] gap-10 md:gap-32 lg:gap-56 md:flex-row-reverse">
      <div
      ...
      >
        {/* <Image
          ...
          /> */}
        <div className="relative w-[150px] h-[250px] md:w-[250px] md:h-[350px] 2xl:w-[350px] 2xl:h-[450px] rounded-2xl overflow-hidden shadow-lg duration-300 ease-in-out transform hover:scale-110">
